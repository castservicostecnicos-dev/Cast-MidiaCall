...
export interface TicketStatus {
  ...
  nextNumber: number;
  formattedNextNormal: string;
  formattedNextPriority: string;
  formattedNextPure: string;
  normalCurrentNumber?: number;
  normalNextNumber?: number;
  priorityCurrentNumber?: number;
  priorityNextNumber?: number;
  formattedNextPriorityPure?: string;
