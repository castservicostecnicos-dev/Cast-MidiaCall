  ...
  return {
    plugins: [
      ...
      VitePWA({
        ...
        manifest: {
          id: '/',
          name: 'CAST MidiaCall - Sistema de Projeção',
          short_name: 'CAST MidiaCall',
          description: 'Sistema completo de gerenciamento e exibição CAST MidiaCall com chamadas e playlists em tempo real.',
          theme_color: '#0f172a',
